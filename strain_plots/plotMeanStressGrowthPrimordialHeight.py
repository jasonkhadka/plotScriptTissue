...
heightplot = fig2.add_subplot(224)
heightplot.set_xlabel(r"Surface Area, $A_T$")
heightplot.set_ylabel(r"Primordia height, $h$")
addAnnotation(heightplot, 3)
...
for key,data in plotData.iteritems():
	...
	############################################################
	heightplot.plot(data[0], data[6],c=color,**plotargs)
	############################################################
############################################################
# Legend of the plot
############################################################
...
if fastkappaOption:# if true calculate with respect to changing fastkappa, else Eta
	...
	fig2.savefig(saveDirectory+r"/plot_eta%d_romeangrowthstress_primoridaheight_areastep=%d_targetface=%d.pdf"%(maxeta,areastep,targetid),transparent = True, bbox_inches="tight")
	fig2.savefig(saveDirectory+r"/plot_eta%d_romeangrowthstress_primoridaheight_areastep=%d_targetface=%d.png"%(maxeta,areastep,targetid),transparent = True, bbox_inches="tight")
	#fig3.savefig(saveDirectory+r"/plot_eta%d_12meangrowthstress_primoridaheight_areastep=%d_targetface=%d.pdf"%(maxeta,areastep,targetid),transparent = True, bbox_inches="tight")
	#fig3.savefig(saveDirectory+r"/plot_eta%d_12meangrowthstress_primoridaheight_areastep=%d_targetface=%d.png"%(maxeta,areastep,targetid),transparent = True, bbox_inches="tight")
	#fig4.savefig(saveDirectory+r"/plot_eta%d_boundaryarea_time=%d_primoridaheight_targetface=%d.pdf"%(maxeta,endStep,targetid),transparent = True, bbox_inches="tight")
