...
def plotRoundness(targetid,othertargetid, targetsurfacearea,endStep = 2000, 
	...
	for steparea in range(initialTissueSurfaceArea, targetsurfacearea, int(areastep)):
		...
		########################################################################
		primordiaRoundness = calculateMeanRoundness(primordialfaces)
		primordialBoundaryRoundness = calculateMeanRoundness(primordialBoundaryfaces)
		othertissueRoundness = calculateMeanRoundness(othertissuefacelist)
		######################################################
