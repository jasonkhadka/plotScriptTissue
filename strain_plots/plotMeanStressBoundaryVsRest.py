###############################################################################################################
# Comparing boundary of primordia vs rest of the tissue 
# for growth rates and for stresses
###############################################################################################################
...
parser.add_argument("-r","--target2", help = "Target face for other side of tissue", default = None, type = int)
...
if fastkappaOption:# if true calculate with respect to changing fastkappa, else Eta
	fig.savefig(saveDirectory+r"/plot_meanstress_meangrowth_comparision_targetface=%d.png"%(endStep,targetid),transparent = True, bbox_inches="tight")
else:
	fig.savefig(saveDirectory+r"/plot_meanstress_meangrowth_comparision_time=%d_targetface=%d.png"%(endStep,targetid),transparent = True, bbox_inches="tight")
...
if fastkappaOption:# if true calculate with respect to changing fastkappa, else Eta
	np.save('meanstress_meangrowth_comparision_fk_time=%d_targetface=%d.npy'%(endStep,targetid),plotData)
else:
	np.save('meanstress_meangrowth_comparision_eta_time=%d_targetface=%d.npy'%(endStep,targetid),plotData)
