...
#               Termination after two consecutive iteration gives same result         
#                             Algorithm : COBYLA                                 #
####################################################################################
...
zbasefreedom = (1./20.)*(2.*np.pi*radius)/perimeterVertexNum#vertex is allowed to move 5% of perimeter
...
for growthcounter in range(growthSteps):
    ...
    if np.isnan(initialenergy):
        ...
        while True:
            ...
            if energyerror < energytolerance: #if return code is one of these then it makes Succesful convergence
                print "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
