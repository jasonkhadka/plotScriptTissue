...
print "epsilon basefreedom", epsbasefreedom
...
##########################################################################
### Small Freedom for Outer vertices #####
################# Upper bounds #################
###base cells###
boundsx[(-1*perimeterVertexNum):] = xcoord[(-1*perimeterVertexNum):]+epsbasefreedom
boundsy[(-1*perimeterVertexNum):] = ycoord[(-1*perimeterVertexNum):]+epsbasefreedom
boundsz[(-1*perimeterVertexNum):] = zcoord[(-1*perimeterVertexNum):]+epsbasefreedom
###Upper cells ###
...
boundsx[:(-1*perimeterVertexNum)] = -basefreedom
boundsy[:(-1*perimeterVertexNum)] = -basefreedom
boundsz[:(-1*perimeterVertexNum)] = -epsbasefreedom
