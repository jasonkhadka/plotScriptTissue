...
if args.cylinder: 
	...
	cellradius = radius
#########    Printing Parameters    ########################
printParameters(cell,numOfLayer)
############################################################################################################
####################################################################################
...
meandeterminantarray = plotMeanTargetArea(cell,meandeterminantarray,0)#initial growth step = 0
###############################################################################################
###################################################################################################################
###							 			START OF SIMULATION 									
###################################################################################################################
for growthcounter in range(growthSteps):
    ...
    if np.isnan(initialenergy):
        ...
        meandeterminantarray = plotMeanTargetArea(cell, meandeterminantarray, growthcounter)
        print "##############################################################################################################################################"
        print "now Optimization !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! step  : ", growthcounter
        print "##############################################################################################################################################"
        relaxationstarttime = time.time() #time before start of optimization
        upperbounds, lowerbouds = getCylindricalBoundsForOptimization(cell,cellradius,perimeterVertexNum)
        ...
        ##########################################################################################
        ## 	Calculation of Parameters and Plotting
        ##########################################################################################
        ...
        ###########################################################################
        plotParametersAfterRelaxation(cell, growthstep,numOfLayer,energyarray, firsttermarray, secondtermarray, thirdtermarray, volumearray, deformations, meanDeformation, stdDeformation, fourthtermarray,relaxation_time_length, functionCallCounterArray)
		matrixdictionary = plotMatrixDictionary(cell,faceidarray, matrixdictionary)
		#######################################################################################################################
		### ~~~~~~~~END OF LOOP~~~~~~~
		#######################################################################################################################        
