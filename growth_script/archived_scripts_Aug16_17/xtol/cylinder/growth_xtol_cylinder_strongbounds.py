...
#                   2. Cylindrical flanks are bound in X-Y with little wiggle room but Z is completely free
...
while vertex != None: 
    ...
    ## DOME VERTEX
    if currentvertid > perimeterVertexNum and currentvertid <= totalvertex:
