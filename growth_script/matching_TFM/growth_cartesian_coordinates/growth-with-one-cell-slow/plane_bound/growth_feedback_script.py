...
#			##############################################
#            Constraints (BOUNDS) : 
#					a. The external vertices are allowed to move in  their X-Y plane for 1 side length
#            
#			##############################################
#            Initial condition :
...
for growthcounter in range(growthSteps):
		...
		if np.isnan(initialenergy):
				...
				upperbounds, lowerbounds = getPlaneBoundsForOptimization(cell,cellradius,perimeterVertexNum)
