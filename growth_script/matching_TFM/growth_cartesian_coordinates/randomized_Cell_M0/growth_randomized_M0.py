...
#           ** This code uses setRandomizedTargetFormMatrix to randomized M0
#           ** 
...
##########################################################################################
## Randomizing the targetform matrix
##########################################################################################
## First lets store the initial target form matrix
meandeterminantarray = []#meandeterminantarray will store the determinant of targetFormMatrx
faces = qd.CellFaceIterator(cell)
face = faces.next()
...
cell = setRandomizedTargetFormMatrix(cell)
cell.setParameters()
##########################################################################################
